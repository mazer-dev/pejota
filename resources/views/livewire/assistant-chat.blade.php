...
>
    ...
    >
            ...
            @forelse ($messages as $chatMessage)
                @if ($chatMessage->role === 'user')
                    <div
                        ...
                        class="ms-6 whitespace-pre-wrap rounded-lg bg-primary-50 px-3 py-2 text-sm text-gray-700 dark:bg-primary-400/10 dark:text-gray-200"
        ...
        {{-- Input --}}
        <form wire:submit="send" class="flex items-center gap-2 border-t border-gray-100 p-2 dark:border-white/10">
            <input
                type="text"
                wire:model="message"
